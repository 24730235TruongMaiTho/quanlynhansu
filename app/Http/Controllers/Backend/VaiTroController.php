...
final class VaiTroController extends Controller
{
    ...
    public function index(Request $request): JsonResponse { return response()->json(['success' => true, 'data' => $this->roles->all((string) $request->input('ten_vt', ''))]); }
    public function search(Request $request): JsonResponse { return $this->index($request); }
