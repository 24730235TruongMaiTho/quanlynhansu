        ...
        <div class="employee-field">
            ...
            >
                ...
                @foreach ($lookups['phong_ban'] as $department)
                    <option value="{{ $department->ma_pb }}" @selected((string) old('ma_pb') === (string) $department->ma_pb)>
                        {{ $department->ten_pb }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="employee-field">
            ...
            >
                ...
                @foreach ($lookups['chuc_vu'] as $position)
                    <option value="{{ $position->ma_cv }}" @selected((string) old('ma_cv') === (string) $position->ma_cv)>
                        {{ $position->ten_cv }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="employee-field">
            ...
            >
                ...
                @foreach ($lookups['trang_thai'] as $status)
                    <option value="{{ $status->ma_tt }}" @selected((string) old('ma_tt') === (string) $status->ma_tt)>
                        {{ $status->ten_tt }}
                    </option>
                @endforeach
            </select>
