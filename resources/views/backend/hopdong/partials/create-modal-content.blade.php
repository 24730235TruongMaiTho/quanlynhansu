<div class="backend-edit-modal-page">
    <form class="card shadow-sm overflow-hidden" method="post" action="{{ route('backend.hopdong.store') }}" data-contract-form data-simple-modal-form>
        @csrf
        ...
        <div class="card-body p-4">
            @include('backend.hopdong.partials.form-fields', ['fieldPrefix' => 'contract-create-'])
        </div>
        <div class="card-footer bg-white d-flex flex-wrap justify-content-end gap-2 py-3">
            ...
            <button class="btn btn-primary btn-icon-text" type="submit" data-submit-edit data-submit data-submitting-text="Đang lưu..."><i class="bi bi-check2" aria-hidden="true"></i><span data-button-label>Lưu hợp đồng</span></button>
        </div>
    </form>
</div>
